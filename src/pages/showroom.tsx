          ...
          <main className={styles.main}>
            <div className={styles.title_desc}>
              <div className={"container " }>
                ...
                <hr/>
                <div className={styles.row+" "+styles.mt45+" "+styles.mb75+" "+styles.showroomBox}>
                  ...
                  <div className={styles.col5}>
                    ...
                    <div className={styles.addressBox+" "+styles.mt15}>
                      <div className={styles.individualBox+" "+styles.activeBox}>
                        <h5>Ababeel Emporio</h5>
                        <p>Thomas Towers Opp. Indira <br/>Bhavan Sasthamngalam Road, <br/>Vellayambalam - Trivandrum</p>
                      </div>
