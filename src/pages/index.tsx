      ...
      <LayoutDefault>
        ...
        <main className={styles.main}>
          <div className="container">
            ...
            <div className={"row d-none d-md-flex " + styles.exProducts}>
              <div className={"col-md-12 " + styles.mb35}>
                ...
                <Slider ref={slider} {...settings}>
                  {/* {index.product_banner.map((content: any, i: number) =>(
                    <>
                    </>
                  ))} */}
                  <div>
            ...
            <div className={"row  d-md-none " + styles.exProducts}>
              <div className={"col-md-12 " + styles.mb35}>
                <h3>
                  Explore <span>Products</span>
                </h3>

                <Slider ref={slider} {...settingsMobile}>
                  {/* {index.product_banner.map((content: any, i: number) =>(
                    <>
                    </>
                  ))} */}
        ...
        <section className={styles.premium}>
          <div className="container">
            <div className={"row " + styles.preTiles}>
              ...
              <div className={"col-md-12 d-none d-md-flex " + styles.mb30}>
              ...
              <div className={"col-md-12 d-md-none " + styles.mb30}>
                <Slider ref={preSlider} {...preSettingsMobile}>
                  <div>
                    <div className={styles.slideInd}>
                      <img src="/home/p2.png" />
                      <p>
